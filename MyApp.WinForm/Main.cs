...
namespace MyApp.WinForm
{
    public partial class Main : Form
    {
        ...
        {
            //TODO : get Active users from Data Layer
        ...
        {
            //TODO : get NonActive users from Data Layer
        ...
        {
            var editUser = new AddEditUser(this, ServiceFactory);
            editUser.Show();
            this.Hide();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                var userId = int.Parse(lstUsers.SelectedItems[0].Text);
                var editUser = new AddEditUser(this, ServiceFactory, userId);
                editUser.Show();
                this.Hide();
            }
        }
